				...
				<div className={"jsx-1025e0387f6b8ad7 jsx-a32c8b4abb10806f jsx-3304264316 grid-container slim"}>
					<div className="jsx-2646878052 Footer_fr__OgTKW grid-item">
						<Link title="ReManga" to="/">
							<h4 className="Typography_h4__PdogT mb-2">ReManga</h4>
						</Link>
						...
						<a href="https://vk.com/im?sel=-185404064" className="hoverLink" title="Задать вопрос" target="_blank" rel="noreferrer">Задать вопрос</a>
						<p className="Typography_body1__YTqxB Typography_color-textSecondary__iFFB7 mt-4 caption">Почта для связи:
							<br/><a className="Typography_body1__YTqxB Typography_color-textPrimary__Qy1D6 p-0 m-0 link" href="mailto:contact@remanga.org">contact@remanga.org</a></p>
						<p className="Typography_caption___iNir Typography_color-textSecondary__iFFB7 mt-4 hidden sm:block">remanga.org 2023</p>
					</div>
